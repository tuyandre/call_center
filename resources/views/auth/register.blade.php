...
<div class="signup-form">
    <form action="{{route('ishyiga.register')}}" method="post">
        @csrf
        <h2>Register</h2>
        ...
        <div class="form-group">
            <div class="row">
                <div class="col">
                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="First Name" required="required">
                    @error('    name')
