...
<head>
    ...
    <link href="{{asset('/public/dashboard/assets/css/dark-style.css')}}" rel="stylesheet">
    <link href="{{asset('/public/dashboard/assets/css/colors/default.css')}}" rel="stylesheet">

    <!-- Color css-->
    <link id="theme" rel="stylesheet" type="text/css" media="all" href="{{asset('/public/dashboard/assets/css/colors/color.css')}}">

    <!-- Select2 css-->
    <link href="{{asset('/public/dashboard/assets/plugins/select2/css/select2.min.css')}}" rel="stylesheet">

    <!-- Mutipleselect css-->
    <link rel="stylesheet" href="{{asset('/public/dashboard/assets/plugins/multipleselect/multiple-select.css')}}">

    <!-- Sidemenu css-->
    <link href="{{asset('/public/dashboard/assets/css/sidemenu/sidemenu.css')}}" rel="stylesheet">
...
<div id="global-loader">
    <img src="{{asset('/public/dashboard/assets/img/loader.svg')}}" class="loader-img" alt="Loader">
</div>
<div class="page">
...
<!-- Select2 js-->
<script src="{{asset('/public/dashboard/assets/plugins/select2/js/select2.min.js')}}"></script>

<!-- Perfect-scrollbar js -->
<script src="{{asset('/public/dashboard/assets/plugins/perfect-scrollbar/perfect-scrollbar.min.js')}}"></script>

<!-- Sidemenu js -->
<script src="{{asset('/public/dashboard/assets/plugins/sidemenu/sidemenu.js')}}"></script>

<!-- Sidebar js -->
<script src="{{asset('/public/dashboard/assets/plugins/sidebar/sidebar.js')}}"></script>

<!-- Internal Chart.Bundle js-->
<script src="{{asset('/public/dashboard/assets/plugins/chart.js/Chart.bundle.min.js')}}"></script>

<!-- Peity js-->
<script src="{{asset('/public/dashboard/assets/plugins/peity/jquery.peity.min.js')}}"></script>

<!-- Internal Morris js -->
<script src="{{asset('/public/dashboard/assets/plugins/raphael/raphael.min.js')}}"></script>
<script src="{{asset('/public/dashboard/assets/plugins/morris.js/morris.min.js')}}"></script>

<!-- Circle Progress js-->
<script src="{{asset('/public/dashboard/assets/js/circle-progress.min.js')}}"></script>
<script src="{{asset('/public/dashboard/assets/js/chart-circle.js')}}"></script>

<!-- Internal Dashboard js-->
<script src="{{asset('/public/dashboard/assets/js/index.js')}}"></script>

<!-- Sticky js -->
<script src="{{asset('/public/dashboard/assets/js/sticky.js')}}"></script>
